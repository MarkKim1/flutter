...
class Utils {
    ...
    var categoryData = [
      {
        ...
        'subCategories': [ // 서브카테고리 제목과 에러 문구는 동일해야함
        ...
        'troubleShootDescribe': [
          {
            "error": "ZD411: When Label is Not Printing Properly", // 서브카테고리 제목과 에러 문구는 동일해야함
            "solutions": [
              {
            ...
            "videoUrl": "https://www.youtube.com/watch?v=-V8UfRF3e2o", // 비디오가 없을 경우 "" 로 표시해야함
          },
          {
      ...
      },
      {
        ...
        'troubleShootDescribe': [
          ...
          },
          {
            ...
            "solutions": [
              {
                "solution": "Ensure the sensor label is properly located and that no debris is blocking it."
        ...
        'troubleShootDescribe' : [
          {
            ...
            "solutions": [
              ...
              },
              {
                ...
                " Choose the 'COM' you want to test which comport a scanner connected to."
                " After choosing the comport press comScanner."
                " If you see a blue letters try scan with scanner",
                "image": "assets/comport2.png"
              },
              {
                "solution": "If scanner properly scans You should see the result below 'Column1'",
      ...
      },
      {
        ...
        'troubleShootDescribe': [
          ...
          },
          {
            ...
            "solutions": [
              {
                "solution": "Make sure HDMI is properly plugged into the computer."
        ...
        'troubleShootDescribe': [
          {
            ...
            "solutions": [
              ...
              {
                "solution": "Slide the finger to the right to open virtual desktop",
              ...
              {
                "solution": "restart the computer. If still having a trouble notice IT",
  ...
  static List<String> searchTerms = [ // 유저가 설치엔진에서 검색할수 있는 범위
    'ZD411: When Label is Not Printing Properly',
    'ZD411: How to Change the darkness of printer',
    'ZD411: How to Perform a Manual Width Adjustment',
    'ZD411: How to Factory reset the ZD411',
